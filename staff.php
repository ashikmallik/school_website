...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
   ...
   <?php 
         ...
         $getheadmasterinfo="SELECT * FROM `staff_info` ORDER BY `serial_no`";
   ...
   ?>
            ...
            <td align="center"><?php echo $shqgetheadmasterinfo['serial_no']; ?></a></td>
            ...
            <td align="center"><img src="admin_zone/pannel/upload/staff/<?php echo $shqgetheadmasterinfo['file_path'];?>" width="60" height="60" /></a></td>
          </tr>
          <?php }?>
                  </table>
