...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
   ...
   <?php 
         ...
         $getheadmasterinfo="SELECT * FROM `notice`";
   ...
   ?>
            ...
            <td align="center"><?php echo $shqgetheadmasterinfo['add_date']; ?></td>
            <td><?php echo $shqgetheadmasterinfo['description']; ?></td>
            <td align="center"><a href="admin_zone/pannel/upload/notice/<?php echo $shqgetheadmasterinfo['file_pathe'];?>" target="_blank">view</a></td>
          </tr>
          <?php }?>
                  </table>
