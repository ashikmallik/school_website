...
<!--========= Single Box End  ==========-->
	    			...
	    			<?php if($publication==1){ ?>    
	    				<h1> ম্যাগাজিন </h1>
	    				<?php } else if($publication==2) { ?>
	    				<h1> এস.এস.সি অ্যালবাম </h1>
	    				<?php }
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
   ...
   <?php 
         ...
         $getheadmasterinfo="SELECT * FROM `publication` WHERE `type` = '$publication'";
 ...
 <td align="center"><?php echo $s; ?></td>      
          <td><?php echo $shqgetheadmasterinfo['title']; ?></td>
            <td align="center"><a href="admin_zone/pannel/upload/publication/<?php echo $shqgetheadmasterinfo['file_path'];?>" target="_blank"></a></td>
          </tr>
          <?php }?>
                  </table>
