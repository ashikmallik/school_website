...
$getglance = "SELECT * FROM `permission_and_nationalization` WHERE  `type` = '2'";
...
<!--========= Single Box End  ==========-->
<h2> জাতীয়করণের তথ্য </h2>
<hr>

<iframe src="admin_zone/pannel/upload/permission/<?php echo $shqgetglance['file'];?>"style="width: 100%;height: 750px;"></iframe>
