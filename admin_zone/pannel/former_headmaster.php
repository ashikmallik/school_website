...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Former Headmaster</button>
                                         </div>
                                    </div>
                                </div>
  		...
  		$gtfeeshead="SELECT * FROM `formar_headmaster`";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center">
        <a class="btn btn-success" href="edit_former.php?id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>
    <a class="btn btn-danger" href="delete_former.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-header">
			        <h4 class="modal-title">Add Former Headmaster</h4>
			        <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
		      	</div>

		      	<!-- Modal body -->
		      	<div class="modal-body">
		        	<form action="formar_headmaster_store.php" method="post" enctype="multipart/form-data" id="add-form">
                                    <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">Name</label>
                                              <div class="col-sm-8">
                                                  <input type="text" id="name" name="name" placeholder="Name" class="form-control"  size="27">
                                              </div>
                                            </div>
                 <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">From</label>
                                              <div class="col-sm-8">
                                                  <input type="text" id="fromdate" name="fromdate" placeholder="From" class="form-control"  size="27">
                                              </div>
                                            </div>
                    <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">To</label>
                                              <div class="col-sm-8">
                                                  <input type="text" id="todate" name="todate" placeholder="To" class="form-control"  size="27">
                                              </div>
                                            </div>                        
