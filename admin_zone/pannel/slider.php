...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Slider</button>
                                         </div>
                                    </div>
                                </div>
  		...
  		$gtfeeshead="SELECT * FROM `slider` ORDER BY `id` DESC";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center"><img src="upload/slider/<?php echo $shgtfeeshead['image_pathe']; ?>" width="120" height="70"/></td>
    <td  align="center">
        <!--<a href="edit_slider.php?slider_id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>-->
    <a href="delete_slider.php?slider_id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="slider_store.php" method="post" enctype="multipart/form-data" id="add-form">
