 ...
 <div class="row">
                            ...
                            <div class="fessPayment">
                                ...
                                <div class="table-responsive newRequestTable headerFixTable">
                                    <table id="data-table" class="table table-striped">
                                        ...
                                        <th scope="col" style="text-align: center;">Class Name</th>                <th scope="col" style="text-align: center;">Shift</th>               
                                            <th scope="col" style="text-align: center;">Section Name</th>
  ...
  ?>
   <tr>
    ...
    <td  align="center"><?php echo $shgtfeeshead['class_name']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['shift']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['section_name']; ?></td>
    <td  align="center">
        <!--<a href="edit_slider.php?slider_id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>-->
    <a href="delete_section.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="section_store.php" method="post" enctype="multipart/form-data" id="add-form">
...
<select class="form-control" id="shift" name="shift"  >
                       ...
                       <div class="col-sm-8">
                      <input type="text" id="section_name" name="section_name" placeholder="Section Name" class="form-control"  size="27">
                       </div>
                       </div>                    
