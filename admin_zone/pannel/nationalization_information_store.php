...
$addtdate = date("d/m/Y");
	...
	$insertintosilder = "INSERT INTO `permission_and_nationalization`(`type`, `file`, `add_date`, `update_date`) VALUES ('2','$fnme','$addtdate','')"; 
		...
		echo "<SCRIPT> 
        alert('$message')
        window.location.replace('nationalization_information.php');
        </SCRIPT>";
        }
        else{
             $message = "Failed";
