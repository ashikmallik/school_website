...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Class</button>
                                         </div>
                                    </div>
                                </div>
  		...
  		$gtfeeshead="SELECT * FROM `class` ORDER BY `class_id` ASC";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center">
        <a class="btn btn-success" href="edit_class.php?id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>
    <a class="btn btn-danger" href="delete_class.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="class_store.php" method="post" enctype="multipart/form-data" id="add-form">
