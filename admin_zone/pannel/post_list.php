...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Post Details</button>
                                         </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive newRequestTable headerFixTable">
                                    <table id="data-table" class="table table-striped">
                                      ...
                                      <th scope="col" style="text-align: center;">Type</th>          
                                            ...
                                            <th scope="col" style="text-align: center;">Total Post</th>
                                            <th scope="col" style="text-align: center;">Empty Post</th>
                                            <th scope="col" style="text-align: center;">Male Post</th>
                                            <th scope="col" style="text-align: center;">Female Post</th>
  		...
  		$gtfeeshead="SELECT * FROM `post_table`";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    echo "Teacher";}else{echo "Staff";}  ?></td>
    <td  align="center"><?php echo $shgtfeeshead['postname']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['totalpost']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['emptypost']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['malepost']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['femalepost']; ?></td>
    <td  align="center">
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-header">
			        <h4 class="modal-title">Add Post Details</h4>
			        <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
		      	</div>

		      	<!-- Modal body -->
		      	<div class="modal-body">
		        	<form action="post_store.php" method="post" enctype="multipart/form-data" id="add-form">
                    ...
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Post Name</label>
                       <div class="col-sm-8">
                      <input type="text" id="postname" name="postname" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>
                        <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Total Post</label>
                       <div class="col-sm-8">
                        <input type="text" id="totalpost" name="totalpost" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>                  
                                
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Empty Post</label>
                       <div class="col-sm-8">
                        <input type="text" id="emptypost" name="emptypost" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>                        
                     <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Male Post</label>
                       <div class="col-sm-8">
                        <input type="text" id="malepost" name="malepost" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>  
                    <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Female Post</label>
                       <div class="col-sm-8">
                        <input type="text" id="femalepost" name="femalepost" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>                          
