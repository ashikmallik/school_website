...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Publication</button>
                                         </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive newRequestTable headerFixTable">
                                    <table id="data-table" class="table table-striped">
                                        <thead class="tableHead">
                                          <tr>
                                                                                <th scope="col" style="text-align: center;">Publication Type</th>
  		...
  		$gtfeeshead="SELECT * FROM `publication` ORDER BY `id` DESC";
		$sl=0;
  ...
  ?>
   <tr>
    <td  align="center"><?php if($shgtfeeshead['type']==1){echo "ম্যাগাজিন";}elseif($shgtfeeshead['type']==2){echo" এস.এস.সি অ্যালবাম ";}elseif($shgtfeeshead['type']==3){echo " অন্যান্য ";}?></td>
    <td  align="center"><?php echo $shgtfeeshead['title']; ?></td>
    <td  align="center">
        <!--<a href="edit_slider.php?slider_id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>-->
    <a href="delete_publication.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="publication_store.php" method="post" enctype="multipart/form-data" id="add-form">
		        	    
		        	 <div class="form-group row">
                        <label  class="col-sm-3 col-form-label">Publication Type</label>
                        <div class="col-sm-8">
                        <select name="type" id="type" class="form-control" >
                            <option value=""> SELECT </option>
                            <option value="1">  ম্যাগাজিন </option>
                            <option value="2">  এস.এস.সি অ্যালবাম </option>
                       ...
                       <div class="col-sm-8">
                                                  <input type="text" id="title" name="title" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div> 
                                            <div class="form-group row">
