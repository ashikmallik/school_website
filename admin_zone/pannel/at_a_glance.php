...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add infrastructure</button>
                                         </div>
                                    </div>
                                </div>
  		...
  		$gtfeeshead="SELECT * FROM `at_a_glance`";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center"><?php echo $shgtfeeshead['descrption']; ?></td>
    <td  align="center">
        <a class="btn btn-success" href="edit_at_a_glance.php?id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>
    <a class="btn btn-danger" href="delete_at_a_glance.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-header">
			        <h4 class="modal-title">Add infrastructure</h4>
			        <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
		      	</div>

		      	<!-- Modal body -->
		      	<div class="modal-body">
		        	<form action="at_a_glance_store.php" method="post" enctype="multipart/form-data" id="add-form">
