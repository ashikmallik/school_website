...
<body>
    ...
    <?php
  		...
  		$gtfeeshead="SELECT * FROM `at_a_glance` where id='$id'";
	  	...
	  	<div class="">
		    <div class="">
		      	...
		      	<div class="modal-body">
		        	<form action="update_at_a_glance.php" method="post" enctype="multipart/form-data" id="add-form">
                                            <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">Title</label>
                                              <div class="col-sm-8">
                                                  <input value="<?php echo stripslashes($shgtfeeshead['title']); ?>" type="text" id="title" name="title" placeholder="Title" class="form-control"  size="27">
                                              </div>
                                            </div>
                                         <div class="form-group row">
                                              <label  class="col-sm-3 col-form-label">Description</label>
                                              <div class="col-sm-8">
                                                  <textarea type="text" id="description" name="description" rows="4" class="form-control"><?php echo stripslashes($shgtfeeshead['descrption']); ?></textarea>
