...
<body>
 ...
 <div class="row">
                            ...
                            <div class="fessPayment">
                                <div class="requestTable">
                                   <div class="requestTableHead">
                                    <h3>Management Committee List</h3>
                                   </div>
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Member</button>
                                         </div>
                                    </div>
                                </div>
  		...
  		$gtfeeshead="SELECT * FROM `gbmember_info` ORDER BY `serial_no` ASC";
		$sl=0;
  ...
  ?>
   <tr>
    ...
    <td  align="center"><img src="upload/gbmenber/<?php echo $shgtfeeshead['image_path']; ?>" width="120" height="100"/></td>
    <td  align="center">
        <a class="btn btn-success" href="edit_gb.php?id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>
    <a class="btn btn-danger" href="delete_gb.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="gbmember_store.php" method="post" enctype="multipart/form-data" id="add-form">
