...
<body>
 ...
 <div class="row">
                                        ...
                                        <div class="reqheadNumber">
                                         ...
                                         <div class="">
                                           <!--<a href="" data-toggle="modal" data-target=".bd-example-modal-lg" style="float: right;">Add New Ticket</a>-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Add Corner</button>
                                         </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive newRequestTable headerFixTable">
                                    <table id="data-table" class="table table-striped">
                                        <thead class="tableHead">
                                          <tr>
                                                                                <th scope="col" style="text-align: center;">Corner Type</th>
  		...
  		$gtfeeshead="SELECT * FROM `corner` ORDER BY `id` DESC";
		$sl=0;
  ...
  ?>
   <tr>
    <td  align="center"><?php if($shgtfeeshead['corner_type']==1){echo "পি.ই.সি কর্নার";}elseif($shgtfeeshead['corner_type']==2){echo "জে.এস.সি কর্নার";}elseif($shgtfeeshead['corner_type']==3){echo "এস.এস.সি কর্নার";}elseif($shgtfeeshead['corner_type']==4){echo "পরীক্ষার আদেশ";}elseif($shgtfeeshead['corner_type']==5){echo "কো-কারিকুলার কর্নার";}elseif($shgtfeeshead['corner_type']==6){echo "ডাউনলোড";} ?></td>
    <td  align="center"><?php echo $shgtfeeshead['description']; ?></td>
    <td  align="center">
        <a class="btn btn-success" href="edit_corner.php?id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>
    <a class="btn btn-danger" href="delete_corner.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
	  	...
	  	<div class="modal-dialog">
		    <div class="modal-content">
		      	...
		      	<div class="modal-header">
			        <h4 class="modal-title">Add Corner</h4>
			        <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
		      	</div>

		      	<!-- Modal body -->
		      	<div class="modal-body">
		        	<form action="corner_store.php" method="post" enctype="multipart/form-data" id="add-form">
