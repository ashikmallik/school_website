...
<div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="nationalization_information_store.php" method="post" enctype="multipart/form-data" id="add-form">
                        ...
                        <thead class="tableHead">
                            <tr>
                                <th scope="col" style="text-align: center;">SL</th>
                                 <th scope="col" style="text-align: center;">view pdf</th>
                                  <th scope="col" style="text-align: center;">Action</th>
                            </tr>
                                          <?php 
                  
               
         $getheadmasterinfo="SELECT * FROM `permission_and_nationalization` WHERE `type` = '2'";
   ...
   ?>
        <tr>
            ...
            <a href="delete_natinalaization.php?id=<?php echo $shqgetheadmasterinfo['id']; ?>">Delete</a>
    </td>
         </tr> 
