! function(e, t) {
    ...
    var p = function(n) {
        ...
        var e, h, _, o, s, p, d, g, w, l, c, E, x, a, T, m, u, v, y, C = "sizzle" + 1 * new Date,
            b = n.document,
            S = 0,
            i = 0,
            A = le(),
            ...
            if (!i && ((e ? e.ownerDocument || e : b) !== x && E(e), e = e || x, T)) {
                ...
                if (h.qsa && !N[t + " "] && (!m || !m.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t, f = e, 1 === d && K.test(t)) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(re, oe) : e.setAttribute("id", a = C), o = (c = p(t)).length; o--;) c[o] = "#" + a + " " + be(c[o]);
        ...
        for (e in h = ae.support = {}, s = ae.isXML = function(e) {
                ...
                return i !== x && 9 === i.nodeType && i.documentElement && (a = (x = i).documentElement, T = !s(x), b !== x && (n = x.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)), h.attributes = ue(function(e) {
        ...
        return ye.prototype = _.filters = _.pseudos, _.setFilters = new ye, p = ae.tokenize = function(e, t) {
            ...
            for (s = e, a = [], l = _.preFilter; s;) {
                for (o in n && !(i = U.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(r = [])), n = !1, (i = $.exec(s)) && (n = i.shift(), r.push({
                        value: n,
                        type: i[0].replace(B, " ")
        ...
        }, h.sortStable = C.split("").sort(I).join("") === C, h.detectDuplicates = !!c, E(), h.sortDetached = ue(function(e) {
                ...
                s = {
                    ...
                    then: function(t, n, i) {
                            ...
                            return function() {
                                function e() {
                                    ...
                                    if (!(r < l)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, b(t) ? a ? t.call(e, c(l, o, R, a), c(l, o, F, a)) : (l++, t.call(e, c(l, o, R, a), c(l, o, F, a), c(l, o, R, o.notifyWith))) : (s !== R && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                        ...
                        return C.Deferred(function(e) {
                            o[0][3].add(c(0, e, b(i) ? i : R, e.notifyWith)), o[1][3].add(c(0, e, b(t) ? t : R)), o[2][3].add(c(0, e, b(n) ? n : F))
                        }).promise()
                    },
                    promise: function(e) {
    ...
    function Y() {
        T.removeEventListener("DOMContentLoaded", Y), x.removeEventListener("load", Y), C.ready()
    }
    ...
    }), C.ready.then = q.then, "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? x.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", Y), x.addEventListener("load", Y));
    ...
    function we(e, t, n, i, r) {
        for (var o, s, a, l, c, u, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++)
            ...
            for (s = s || f.appendChild(t.createElement("div")), a = (he.exec(o) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + C.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
        ...
        o ? (V.set(e, r, !1), C.event.add(e, r, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    ...
                    else if (i = a.call(arguments), V.set(this, r, i), t = o(this, r), this[r](), i !== (n = V.get(this, r)) || t ? V.set(this, r, !1) : n = {}, i !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value
        ...
        add: function(t, e, n, i, r) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(re, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                    ...
                    }), c = (e = (e || "").match(H) || [""]).length; c--;) h = g = (a = Te.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), h && (f = C.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = C.event.special[h] || {}, u = C.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        remove: function(e, t, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--;)
                    if (h = g = (a = Te.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), h) {
    ...
    function Fe(n, i, r, o) {
        ...
        if (f && (t = (e = we(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = C.map(me(e, "script"), Pe)).length; u < f; u++) l = e, u !== d && (l = C.clone(l, !0, !0), a && C.merge(s, me(l, "script"))), r.call(n[u], l, u);
            if (a)
                for (c = s[s.length - 1].ownerDocument, C.map(s, He), u = 0; u < a; u++) l = s[u], pe.test(l.type || "") && !V.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || me(e), s = s || me(u), i = 0, r = o.length; i < r; i++) Re(o[i], s[i]);
                else Re(e, u);
    ...
    var Me, qe, Ye, Xe, Be, Ue, $e, Ke = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"),
        ze = function(e) {
    ...
    function Ve() {
        if ($e) {
            Ue.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", $e.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", re.appendChild(Ue).appendChild($e);
            var e = x.getComputedStyle($e);
            Me = "1%" !== e.top, Be = 12 === Ge(e.marginLeft), $e.style.right = "60%", Xe = 36 === Ge(e.right), qe = 36 === Ge(e.width), $e.style.position = "absolute", Ye = 12 === Ge($e.offsetWidth / 3), re.removeChild(Ue), $e = null
        }
    }
    ...
    function Ze(e, t, n) {
        ...
        return (n = n || ze(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = C.style(e, t)), !y.pixelBoxStyles() && Ke.test(s) && Qe.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function ut(e, t, n) {
        ...
        return (!y.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === C.css(e, "boxSizing", !1, i), (o = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + ct(e, t, n || (r ? "border" : "content"), o, i, s) + "px"
    }
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (o = typeof n) && (r = ne.exec(n)) && r[1] && (n = ce(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = K(t);
            return ot.test(t) || (t = it(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Ze(e, t, i)), "normal" === r && t in at && (r = at[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
        ...
        C.cssHooks[l] = {
            ...
            set: function(e, t, n) {
                var i, r = ze(e),
                    ...
                    a = n ? ct(e, l, n, s, r) : 0;
                return s && o && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(r[l]) - ct(e, l, "border", !1, r) - .5)), a && (i = ne.exec(t)) && "px" !== (i[3] || "px") && (e.style[l] = t, t = C.css(e, l)), lt(0, t, a)
            }
        }
    ...
    function yt() {
        ht && (!1 === T.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(yt) : x.setTimeout(yt, C.fx.interval), C.fx.tick())
    }
    ...
    function Et(o, e, t) {
        ...
        for (! function(e, t) {
            ...
            if (n = Et.prefilters[i].call(c, o, u, c.opts)) return b(n.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
    ...
    C.Animation = C.extend(Et, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, r = (e = b(e) ? (t = e, ["*"]) : e.match(H)).length; i < r; i++) n = e[i], Et.tweeners[n] = Et.tweeners[n] || [], Et.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h))
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = V.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (fe([e], !0), c = e.style.display || c, u = C.css(e, "display"), fe([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (d.done(function() {
                        p.display = c
    ...
    C.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? xt : void 0)), void 0 !== n ? null === n ? void C.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (o = f = s = n = n || T, 3 !== n.nodeType && 8 !== n.nodeType && !Ot.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(), p.sort()), l = h.indexOf(":") < 0 && "on" + h, (e = e[C.expando] ? e : new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), u = C.event.special[h] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || h, Ot.test(a + h) || (o = o.parentNode); o; o = o.parentNode) d.push(o), s = o;
                    s === (n.ownerDocument || T) && d.push(s.defaultView || s.parentWindow || x)
                }
                for (r = 0;
                    (o = d[r++]) && !e.isPropagationStopped();) f = o, e.type = 1 < r ? a : u.bindType || h, (c = (V.get(o, "events") || {})[e.type] && V.get(o, "handle")) && c.apply(o, t), (c = l && o[l]) && c.apply && z(o) && (e.result = c.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = h, i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !z(n) || l && b(n[h]) && !g(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = h, e.isPropagationStopped() && f.addEventListener(h, It), n[h](), e.isPropagationStopped() && f.removeEventListener(h, It), C.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    Vt.href = Lt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (b.promise(E), m.url = ((e || m.url || Lt.href) + "").replace($t, Lt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(H) || [""], null == m.crossDomain) {
                i = T.createElement("a");
                try {
            ...
            if (m.data && m.processData && "string" != typeof m.data && (m.data = C.param(m.data, m.traditional)), Zt(Kt, m, t, E), p) return E;
            for (r in (g = C.event && m.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !Ut.test(m.type), f = m.url.replace(Yt, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(qt, "+")) : (o = m.url.slice(f.length), m.data && (m.processData || "string" == typeof m.data) && (f += (Pt.test(f) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (f = f.replace(Xt, "$1"), o = (Pt.test(f) ? "&" : "?") + "_=" + jt++ + o), m.url = f + o), m.ifModified && (C.lastModified[f] && E.setRequestHeader("If-Modified-Since", C.lastModified[f]), C.etag[f] && E.setRequestHeader("If-None-Match", C.etag[f])), (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && E.setRequestHeader("Content-Type", m.contentType), E.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Qt + "; q=0.01" : "") : m.accepts["*"]), m.headers) E.setRequestHeader(r, m.headers[r]);
            ...
            function c(e, t, n, i) {
                var r, o, s, a, l, c = t;
                p || (p = !0, h && x.clearTimeout(h), u = void 0, d = i || "", E.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
    ...
    C.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(on, "$1" + i) : !1 !== e.jsonp && (e.url += (Pt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
            return o || C.error(i + " was not called"), o[0]
        }, e.dataTypes[0] = "json", r = x[i], x[i] = function() {
            o = arguments
        }, n.always(function() {
            void 0 === r ? C(x).removeProp(i) : x[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, rn.push(i)), o && b(r) && r(o[0]), o = r = void 0
        }), "script"
        ...
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = At(e.slice(a)), e = e.slice(0, a)), b(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && C.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, c = C.css(e, "position"),
                u = C(e),
                f = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), o = C.css(e, "top"), l = C.css(e, "left"), r = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (i = u.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), b(t) && (t = t.call(e, n, C.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : u.css(f)
        }
    }, C.fn.extend({
        offset: function(t) {
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = D, C.isFunction = b, C.isWindow = g, C.camelCase = K, C.type = w, C.now = Date.now, C.isNumeric = function(e) {
        var t = C.type(e);
...
function(e, t) {
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        e.offsets.reference = c(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = a(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = D(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = N(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                    }
                }.call(this)
            }
        }, {
    ...
    function te(e, t) {
        ...
        }, this.update = X(this.update.bind(this)), this.options = K({}, te.Defaults, i), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var n, i = t.offset,
                        ...
                        a = o.reference,
                        l = r.split("-")[0];
                    return n = u(+i) ? [+i, 0] : L(i, s, a, l), "left" === l ? (s.top += n[0], s.left -= n[1]) : "right" === l ? (s.top += n[0], s.left += n[1]) : "top" === l ? (s.left += n[0], s.top -= n[1]) : "bottom" === l && (s.left += n[0], s.top += n[1]), e.popper = s, e
                },
                offset: 0
            },
            preventOverflow: {
                        ...
                        f = {
                            ...
                            secondary: function(e) {
                                var t = "right" === e ? "left" : "top",
                                    n = u[t];
                                return u[e] > l[e] && !i.escapeWithReference && (n = j(u[t], l[e] - ("right" === e ? u.width : u.height))), Y({}, t, n)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    return b = R(j(s[c] - p, b), 0), e.arrowElement = i, e.offsets.arrow = (Y(n = {}, f, H(b)), Y(n, d, ""), n), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(g, m) {
                    ...
                    return w.forEach(function(e, t) {
                        ...
                        }(_)), g.placement = y + (_ ? "-" + _ : ""), g.offsets.popper = K({}, g.offsets.popper, D(g.instance.popper, g.offsets.reference, g.placement)), g = N(g.instance.modifiers, g, "flip"))
                    }), g
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = A(t), e.offsets.popper = E(r), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    return e.attributes = K({}, y, e.attributes), e.styles = K({}, f, e.styles), e.arrowStyles = K({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
function(e, t) {
    ...
    p(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', v._handleDismiss(new v)), p.fn[r] = v._jQueryInterface, p.fn[r].Constructor = v, p.fn[r].noConflict = function() {
    ...
    var L = "carousel",
        ...
        le = function() {
            ...
            return e.next = function() {
                ...
                if (r = e === M ? (n = Q, i = V, Y) : (n = z, i = G, X), l && p(l).hasClass($)) this._isSliding = !1;
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new o(this, t), p(this).data(j, e)), "number" == typeof i) e.to(i);
                ...
                if (t) {
                    ...
                    if (n && p(n).hasClass(U)) {
                        ...
                        r && (i.interval = !1), o._jQueryInterface.call(p(n), i), r && p(n).data(j).to(r), e.preventDefault()
                    }
                }
            }, s(o, null, [{
                key: "VERSION",
            ...
            return e.toggle = function() {
                ...
                if (!this._isTransitioning && !p(this._element).hasClass(me) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(Ee)).filter(function(e) {
                    ...
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        p(this._element).removeClass(ve).addClass(ye), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(be).attr("aria-expanded", !0), this.setTransitioning(!0);
        ...
        Ze = function() {
            ...
            return e.toggle = function() {
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (p(e).trigger(i), !i.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var r = this._element;
                                "parent" === this._config.reference ? r = e : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(e).addClass(Fe), this._popper = new f(r, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(e).closest(Ye).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Le), p(e).toggleClass(Le).trigger(p.Event(Ie.SHOWN, n))
                        }
                    }
                }
            }, e.show = function() {
                ...
                var e = p(this._element.parentNode),
                    t = $e;
                return e.hasClass(je) ? (t = Be, p(this._menu).hasClass(Re) && (t = Ue)) : e.hasClass(Pe) ? t = ze : e.hasClass(He) ? t = Qe : p(this._menu).hasClass(Re) && (t = Ke), t
                    ...
                    for (var t = [].slice.call(document.querySelectorAll(We)), n = 0, i = t.length; n < i; n++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), o) {
                            ...
                            if (p(r).hasClass(Le) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                                ...
                                p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(Le), p(r).removeClass(Le).trigger(p.Event(Ie.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(qe).length)) : Ne.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Oe))) {
    ...
    var Je = "modal",
        ...
        yt = function() {
            ...
            return e.toggle = function(e) {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(st) ? this._dialog.querySelector(ht).scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(ft), this._config.focus && this._enforceFocus();
        ...
        Ut = function() {
            ...
            return e.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && p(r).addClass(Rt);
                ...
                function t() {
                    n._hoverState !== jt && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), e && e()
                }
                var n = this,
                    i = this.getTipElement(),
                    r = p.Event(this.constructor.Event.HIDE);
                if (p(this.element).trigger(r), !r.isDefaultPrevented()) {
                    if (p(i).removeClass(Ft), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Xt] = !1, this._activeTrigger[Yt] = !1, this._activeTrigger[qt] = !1, p(this.tip).hasClass(Rt)) {
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Yt : qt] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Pt, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return Object.keys(t).forEach(function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), g.typeCheckConfig(Tt, e, this.constructor.DefaultType), e.sanitize && (e.template = xt(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                null === e.getAttribute("x-placement") && (p(e).removeClass(Rt), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function(n) {
                return this.each(function() {
        ...
        sn = function(e) {
            ...
            return t.isWithContent = function() {
                ...
                return this.each(function() {
                    ...
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), p(this).data(Kt, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    var an = "scrollspy",
        ...
        Sn = function() {
            function n(e, t) {
                var n = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + yn + "," + this._config.target + " " + _n + "," + this._config.target + " " + En, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(hn.SCROLL, function(e) {
                    return n._process(e)
            ...
            return e.refresh = function() {
                ...
                p.removeData(this._element, ln), p(this._scrollElement).off(cn), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                ...
                n.hasClass(pn) ? (n.closest(wn).find(xn).addClass(gn), n.addClass(gn)) : (n.addClass(gn), n.parents(vn).prev(yn + ", " + _n).addClass(gn), n.parents(vn).prev(bn).children(yn).addClass(gn)), p(this._scrollElement).trigger(hn.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function() {
        ...
        Xn = function() {
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(On) || p(this._element).hasClass(Ln))) {
                    var e, i, t = p(this._element).closest(Rn)[0],
                ...
                if (p(e).addClass(On), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g.reflow(e), e.classList.contains(jn) && e.classList.add(Pn), e.parentNode && p(e.parentNode).hasClass(In)) {
    ...
    var Bn = "toast",
        ...
        ni = function() {
            ...
            return e.show = function() {
                ...
                function t() {
                    e._element.classList.remove(Zn), e._element.classList.add(Gn), p(e._element).trigger(zn.SHOWN), e._config.autohide && e.hide()
                }
                ...
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gn) && this._element.classList.remove(Gn), p(this._element).off(zn.CLICK_DISMISS), p.removeData(this._element, Un), this._element = null, this._config = null
            }, e._getConfig = function(e) {
                return e = l({}, ei, p(this._element).data(), "object" == typeof e && e ? e : {}), g.typeCheckConfig(Bn, e, this.constructor.DefaultType), e
            }, e._setListeners = function() {
                var e = this;
    ...
    p.fn[Bn] = ni._jQueryInterface, p.fn[Bn].Constructor = ni, p.fn[Bn].noConflict = function() {
        ...
        }(), e.Util = g, e.Alert = v, e.Button = O, e.Carousel = le, e.Collapse = Te, e.Dropdown = Ze, e.Modal = yt, e.Popover = sn, e.Scrollspy = Sn, e.Tab = Xn, e.Toast = ni, e.Tooltip = Ut, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function o(s, a, l) {
        ...
        function i(a, e) {
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function() {
                ...
                if (f) {
                    ...
                    t < i + 3 ? (c.left = -5, d.startScrolling(a, "x")) : r - 3 < t ? (c.left = 5, d.startScrolling(a, "x")) : c.left = 0, n < o + 3 ? (c.top = o + 3 - n < 5 ? -5 : -20, d.startScrolling(a, "y")) : s - 3 < n ? (c.top = n - s + 3 < 5 ? 5 : 20, d.startScrolling(a, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? u() : l = l || setInterval(function() {
                        h.get(a) ? (g(a, "top", a.scrollTop + c.top), g(a, "left", a.scrollLeft + c.left), p(a)) : clearInterval(l)
                    }, 50)
                }
            })
        }
        ...
        function r(a, l, e, t) {
            ...
            function s() {
                !h && p && (p = !1, clearInterval(n), n = setInterval(function() {
                    y.get(a) && (d.x || d.y) ? Math.abs(d.x) < .01 && Math.abs(d.y) < .01 ? clearInterval(n) : (c(30 * d.x, 30 * d.y), d.x *= .8, d.y *= .8) : clearInterval(n)
                }, 10))
            }
            e ? (l.event.bind(window, "touchstart", i), l.event.bind(window, "touchend", r), l.event.bind(a, "touchstart", v), l.event.bind(a, "touchmove", o), l.event.bind(a, "touchend", s)) : t && (window.PointerEvent ? (l.event.bind(window, "pointerdown", i), l.event.bind(window, "pointerup", r), l.event.bind(a, "pointerdown", v), l.event.bind(a, "pointermove", o), l.event.bind(a, "pointerup", s)) : window.MSPointerEvent && (l.event.bind(window, "MSPointerDown", i), l.event.bind(window, "MSPointerUp", r), l.event.bind(a, "MSPointerDown", v), l.event.bind(a, "MSPointerMove", o), l.event.bind(a, "MSPointerUp", s)))
        }
        t.exports = function(e) {
    ...
    19: [function(e, t, n) {
        ...
        t.exports = function(e) {
            var t, n = s.get(e);
            n.containerWidth = e.clientWidth, n.containerHeight = e.clientHeight, n.contentWidth = e.scrollWidth, n.contentHeight = e.scrollHeight, e.contains(n.scrollbarXRail) || (0 < (t = o.queryChildren(e, ".ps-scrollbar-x-rail")).length && t.forEach(function(e) {
                    o.remove(e)
                    ...
                    o.remove(e)
                }), o.appendTo(n.scrollbarYRail, e)), !n.settings.suppressScrollX && n.containerWidth + n.settings.scrollXMarginOffset < n.contentWidth ? (n.scrollbarXActive = !0, n.railXWidth = n.containerWidth - n.railXMarginWidth, n.railXRatio = n.containerWidth / n.railXWidth, n.scrollbarXWidth = l(n, i.toInt(n.railXWidth * n.containerWidth / n.contentWidth)), n.scrollbarXLeft = i.toInt((n.negativeScrollAdjustment + e.scrollLeft) * (n.railXWidth - n.scrollbarXWidth) / (n.contentWidth - n.containerWidth))) : n.scrollbarXActive = !1, !n.settings.suppressScrollY && n.containerHeight + n.settings.scrollYMarginOffset < n.contentHeight ? (n.scrollbarYActive = !0, n.railYHeight = n.containerHeight - n.railYMarginHeight, n.railYRatio = n.containerHeight / n.railYHeight, n.scrollbarYHeight = l(n, i.toInt(n.railYHeight * n.containerHeight / n.contentHeight)), n.scrollbarYTop = i.toInt(e.scrollTop * (n.railYHeight - n.scrollbarYHeight) / (n.contentHeight - n.containerHeight))) : n.scrollbarYActive = !1, n.scrollbarXLeft >= n.railXWidth - n.scrollbarXWidth && (n.scrollbarXLeft = n.railXWidth - n.scrollbarXWidth), n.scrollbarYTop >= n.railYHeight - n.scrollbarYHeight && (n.scrollbarYTop = n.railYHeight - n.scrollbarYHeight),
                function(e, t) {
                    var n = {
                        width: t.railXWidth
                    };
                    ...
                    t.isScrollbarYUsingRight ? t.isRtl ? i.right = t.contentWidth - (t.negativeScrollAdjustment + e.scrollLeft) - t.scrollbarYRight - t.scrollbarYOuterWidth : i.right = t.scrollbarYRight - e.scrollLeft : t.isRtl ? i.left = t.negativeScrollAdjustment + e.scrollLeft + 2 * t.containerWidth - t.contentWidth - t.scrollbarYLeft - t.scrollbarYOuterWidth : i.left = t.scrollbarYLeft + e.scrollLeft, o.css(t.scrollbarYRail, i), o.css(t.scrollbarX, {
                ...
                }(e, n), n.scrollbarXActive ? r.add(e, "ps-active-x") : (r.remove(e, "ps-active-x"), n.scrollbarXWidth = 0, n.scrollbarXLeft = 0, a(e, "left", 0)), n.scrollbarYActive ? r.add(e, "ps-active-y") : (r.remove(e, "ps-active-y"), n.scrollbarYHeight = 0, n.scrollbarYTop = 0, a(e, "top", 0))
        }
    }, {
        "../lib/class": 2,
        "../lib/dom": 3,
    ...
    20: [function(e, t, n) {
        ...
        t.exports = function(e, t, n) {
            ...
            var i = a.get(e);
            "top" === t && n >= i.contentHeight - i.containerHeight && ((n = i.contentHeight - i.containerHeight) - e.scrollTop <= 1 ? n = e.scrollTop : e.scrollTop = n, e.dispatchEvent(r("ps-y-reach-end"))), "left" === t && n >= i.contentWidth - i.containerWidth && ((n = i.contentWidth - i.containerWidth) - e.scrollLeft <= 1 ? n = e.scrollLeft : e.scrollLeft = n, e.dispatchEvent(r("ps-x-reach-end"))), o = o || e.scrollTop, s = s || e.scrollLeft, "top" === t && n < o && e.dispatchEvent(r("ps-scroll-up")), "top" === t && o < n && e.dispatchEvent(r("ps-scroll-down")), "left" === t && n < s && e.dispatchEvent(r("ps-scroll-left")), "left" === t && s < n && e.dispatchEvent(r("ps-scroll-right")), "top" === t && (e.scrollTop = o = n, e.dispatchEvent(r("ps-scroll-y"))), "left" === t && (e.scrollLeft = s = n, e.dispatchEvent(r("ps-scroll-x")))
        }
    }, {
        "./instances": 18
    }],
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(c) {
        var u = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            I = {
                    ...
                    DFS: function e(t, n, i, r) {
                        ...
                        for (var s in t)
                            if (t.hasOwnProperty(s)) {
                                ...
                                var a = t[s],
                                    l = I.util.type(a);
                                "Object" !== l || r[o(a)] ? "Array" !== l || r[o(a)] || (r[o(a)] = !0, e(a, n, s, r)) : (r[o(a)] = !0, e(a, n, null, r))
                            }
                    }
                },
                plugins: {},
                ...
                highlightElement: function(e, t, n) {
                    ...
                    o && (r = (o.className.match(u) || [, "none"])[1].toLowerCase(), i = I.languages[r]), e.className = e.className.replace(u, "").replace(/\s+/g, " ") + " language-" + r, e.parentNode && (o = e.parentNode, /pre/i.test(o.nodeName) && (o.className = o.className.replace(u, "").replace(/\s+/g, " ") + " language-" + r));

                    function s(e) {
                        a.highlightedCode = e, I.hooks.run("before-insert", a), a.element.innerHTML = a.highlightedCode, I.hooks.run("after-highlight", a), I.hooks.run("complete", a), n && n.call(a.element)
                    }
                    var a = {
                        element: e,
                        language: r,
                    ...
                    if (I.hooks.run("before-sanity-check", a), a.code)
                        if (I.hooks.run("before-highlight", a), a.grammar)
                            ...
                            } else s(I.highlight(a.code, a.grammar, a.language));
                ...
                highlight: function(e, t, n) {
                    ...
                    return I.hooks.run("before-tokenize", i), i.tokens = I.tokenize(i.code, i.grammar), I.hooks.run("after-tokenize", i), O.stringify(I.util.encode(i.tokens), i.language)
                },
                                ...
                                for (var v = i, y = r; v < t.length; y += t[v].length, ++v) {
                                    ...
                                    if (!(b instanceof O)) {
                                        if (h && v != t.length - 1) {
                                            ...
                                            for (var _ = C.index + (d ? C[1].length : 0), w = C.index + C[0].length, E = v, x = y, T = t.length; E < T && (x < w || !t[E].type && !t[E - 1].greedy); ++E)(x += t[E].length) <= _ && (++v, y = x);
                                        ...
                                        if (C) {
                                            ...
                                            if (k.push(N), D && k.push(D), Array.prototype.splice.apply(t, k), 1 != S && I.matchGrammar(e, t, n, v, y, !0, a), o) break
                                        } else if (o) break
                                    }
                                }
                            }
        ...
        return e && (I.filename = e.src, I.manual || e.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(I.highlightAll) : window.setTimeout(I.highlightAll, 16) : document.addEventListener("DOMContentLoaded", I.highlightAll))), I
    }(_self);
