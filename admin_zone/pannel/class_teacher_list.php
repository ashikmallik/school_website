 ...
 <div class="row">
                                ...
                                <div class="table-responsive newRequestTable headerFixTable">
                                    <table id="data-table" class="table table-striped">
                                        <thead class="tableHead">
                                          <tr>
                                            <th scope="col" style="text-align: center;"> Class Teacher Name</th>
  ...
  ?>
   <tr>
    ...
    <td  align="center"><?php echo $shgtfeeshead['session']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['class_name']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['shift']; ?></td>
    <td  align="center"><?php echo $shgtfeeshead['section']; ?></td>
   
    <td  align="center">
        <!--<a href="edit_slider.php?slider_id=<?php echo $shgtfeeshead['id']; ?>">Edit</a>-->
    <a href="delete_class_teacher.php?id=<?php echo $shgtfeeshead['id']; ?>">Delete</a>
    </td>
  </tr>
