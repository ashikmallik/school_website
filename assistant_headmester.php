...
<!--========= Single Box End  ==========-->
	    			...
	    			<?php if($shift=='Morning'){ ?>    
	    				<h1> সহকারী প্রধান শিক্ষক (প্রভাতি) </h1>
	    				<?php } elseif($shift=='Day') { ?>
	    				<h1> সহকারী প্রধান শিক্ষক (দিবা) </h1>
	    				<?php } else { ?>
	    				<h1> সহকারী প্রধান শিক্ষক  </h1>
	    				<?php } ?>
	    			</div>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
          <tr height="30">
            ...
            <td width="450" align="left">Teacher Name</td>
            <td width="60" align="center">Photo</td>
          </tr>
   <?php 
                  
               
         $getheadmasterinfo="SELECT * FROM `teacher_info` WHERE `designation` IN('Assistant Headmaster') AND `teacher_shift` = '$shift'";
   ...
   ?>
            ...
            <td align="center"><a target="_blank" href="teachers_details.php?Id=<?php echo $shqgetheadmasterinfo['id']; ?>"><?php echo $shqgetheadmasterinfo['teacher_id']; ?></a></td>
            <td><a target="_blank" href="teachers_details.php?Id=<?php echo $shqgetheadmasterinfo['id']; ?>"><?php echo $shqgetheadmasterinfo['name']; ?></a>
            </td>
            <td align="center"><img src="admin_zone/pannel/upload/teacher/<?php echo $shqgetheadmasterinfo['image_path'];?>" width="60" height="60" /></a></td>
          </tr>
          <?php }?>
                  </table>
