...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
          <tr height="30">
            ...
            <td width="100" align="center">Shift</td>
            <td width="100" align="center">Section</td>
          </tr>
   <?php 
                  
               
         $getheadmasterinfo="SELECT * FROM `teacher_info` WHERE `isClassTeacher` = 1 ORDER BY `serial_no` ASC";
   ...
   ?>
                    <tr>
            <td align="center"><?php echo $shqgetheadmasterinfo['name']; ?>
            <td align="center"><?php echo $shqgetheadmasterinfo['session']; ?></td>
            <td align="center"><?php echo $shqgetheadmasterinfo['class_name']; ?></td>
            <td align="center"><?php echo $shqgetheadmasterinfo['shift']; ?></td>
            <td align="center"><?php echo $shqgetheadmasterinfo['section']; ?></td>
            </td>
          </tr>
          <?php }?>
                  </table>
