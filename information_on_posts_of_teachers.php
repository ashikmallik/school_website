...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#609513">
          <tr height="30">
            <td width="100" align="center">পদের নাম</td>
            <td width="100" align="center">পুরুষ পদ সংখ্যা</td>
            <td width="100" align="center">মহিলা পদ সংখ্যা</td>
            <td width="100" align="center">শুন্য পদ সংখ্যা</td>
            <td width="100" align="center">মোট পদ সংখ্যা</td>
          </tr>
   
                    <tr>
        <?php 
        
        $getformer = "SELECT * FROM `post_table` WHERE `type` = 1";
        ...
        ?>                
            ...
            <td><?php echo "&nbsp ".$shqgetformer['postname']; ?></td>
            <td><?php echo "&nbsp ".$shqgetformer['malepost']; ?></td>
            <td><?php echo "&nbsp ".$shqgetformer['femalepost']; ?></td>
            <td><?php echo "&nbsp ".$shqgetformer['emptypost']; ?></td>
            <td><?php echo "&nbsp ".$shqgetformer['totalpost']; ?></td>
