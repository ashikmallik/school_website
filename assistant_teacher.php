...
<!--========= Single Box End  ==========-->
	    			...
	    			<?php if($shift=='Morning'){ ?>    
	    				<h1> সহকারী শিক্ষক (প্রভাতি) </h1>
	    				<?php } elseif($shift=='Day') { ?>
	    				<h1> সহকারী শিক্ষক (দিবা)</h1>
	    				<?php }  else { ?>
	    				<h1> সহকারী শিক্ষক</h1>
	    				<?php } ?>
	    			</div>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
   ...
   <?php 
         ...
         $getheadmasterinfo="SELECT * FROM `teacher_info` WHERE `designation` NOT IN ('Headmaster','Assistant Headmaster') AND `teacher_shift` = '$shift'";
